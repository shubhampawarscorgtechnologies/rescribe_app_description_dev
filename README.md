# Rescribe — How the Apps Work (dev)

Functional documentation for the Rescribe hospital apps, written for support teams
and hospital staff. This is the **dev** copy — the app build for dev opens it
from its menu.
...
Live: https://shubhampawarscorgtechnologies.github.io/rescribe_app_description_dev/
...
`python3 docs/_src/sync_site.py dev`.
